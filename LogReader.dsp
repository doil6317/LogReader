# Microsoft Developer Studio Project File - Name="LogReader" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** 編集しないでください **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=LogReader - Win32 Debug
!MESSAGE これは有効なﾒｲｸﾌｧｲﾙではありません。 このﾌﾟﾛｼﾞｪｸﾄをﾋﾞﾙﾄﾞするためには NMAKE を使用してください。
!MESSAGE [ﾒｲｸﾌｧｲﾙのｴｸｽﾎﾟｰﾄ] ｺﾏﾝﾄﾞを使用して実行してください
!MESSAGE 
!MESSAGE NMAKE /f "LogReader.mak".
!MESSAGE 
!MESSAGE NMAKE の実行時に構成を指定できます
!MESSAGE ｺﾏﾝﾄﾞ ﾗｲﾝ上でﾏｸﾛの設定を定義します。例:
!MESSAGE 
!MESSAGE NMAKE /f "LogReader.mak" CFG="LogReader - Win32 Debug"
!MESSAGE 
!MESSAGE 選択可能なﾋﾞﾙﾄﾞ ﾓｰﾄﾞ:
!MESSAGE 
!MESSAGE "LogReader - Win32 Release" ("Win32 (x86) Application" 用)
!MESSAGE "LogReader - Win32 Debug" ("Win32 (x86) Application" 用)
!MESSAGE 
...
!IF  "$(CFG)" == "LogReader - Win32 Release"
...
!ELSEIF  "$(CFG)" == "LogReader - Win32 Debug"
...
# Name "LogReader - Win32 Release"
# Name "LogReader - Win32 Debug"
